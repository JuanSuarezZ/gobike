...
class CustomPainterBike extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    Path path_0 = Path();
    path_0.moveTo(size.width * 0.5280667, size.height * 0.6662750);
    path_0.cubicTo(
        ...
        size.width * 0.5061667,
        size.height * 0.7384500);
    path_0.lineTo(size.width * 0.5650500, size.height * 0.7802750);
    path_0.cubicTo(
        ...
        size.width * 0.5427167,
        size.height * 0.7244750);
    path_0.lineTo(size.width * 0.5519833, size.height * 0.6826250);
    path_0.cubicTo(
    ...
    paint_0_fill.color = Color(0xffFFB09E).withOpacity(1.0);
    canvas.drawPath(path_0, paint_0_fill);

    Path path_1 = Path();
    path_1.moveTo(size.width * 0.5428500, size.height * 0.7246500);
    path_1.lineTo(size.width * 0.5661667, size.height * 0.7799000);
    path_1.cubicTo(
    ...
    paint_1_fill.color = Color(0xffE26191).withOpacity(1.0);
    canvas.drawPath(path_1, paint_1_fill);

    Path path_2 = Path();
    path_2.moveTo(size.width * 0.5443000, size.height * 0.7277000);
    path_2.lineTo(size.width * 0.5352000, size.height * 0.7340500);
    path_2.cubicTo(
    ...
    path_2.lineTo(size.width * 0.5331000, size.height * 0.7426750);
    path_2.cubicTo(
    ...
    path_2.lineTo(size.width * 0.5490500, size.height * 0.7387000);

    Paint paint_2_stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.001527000;
    paint_2_stroke.color = Color(0xffFCF9F5).withOpacity(1.0);
    canvas.drawPath(path_2, paint_2_stroke);

    Path path_3 = Path();
    path_3.moveTo(size.width * 0.5276833, size.height * 0.6659750);
    path_3.lineTo(size.width * 0.5168333, size.height * 0.7006500);
    path_3.cubicTo(
    ...
    path_3.cubicTo(
        ...
        size.width * 0.5379167,
        size.height * 0.6733750);
    path_3.lineTo(size.width * 0.5276833, size.height * 0.6659750);
    path_3.close();

    Paint paint_3_fill = Paint()..style = PaintingStyle.fill;
    paint_3_fill.color = Color(0xffD47082).withOpacity(1.0);
    canvas.drawPath(path_3, paint_3_fill);

    Path path_4 = Path();
    path_4.moveTo(size.width * 0.3924833, size.height * 0.4438250);
    path_4.cubicTo(
    ...
    paint_4_fill.color = Color(0xff34753D).withOpacity(1.0);
    canvas.drawPath(path_4, paint_4_fill);

    Path path_5 = Path();
    path_5.moveTo(size.width * 0.6698833, size.height * 0.3861500);
    path_5.lineTo(size.width * 0.6623500, size.height * 0.3619250);
    path_5.cubicTo(
    ...
    path_5.lineTo(size.width * 0.6091667, size.height * 0.3503500);

    Paint paint_5_stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.008286500;
    paint_5_stroke.color = Color(0xffF7B767).withOpacity(1.0);
    ...
    Paint paint_6_stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.008286500;
    paint_6_stroke.color = Color(0xff222343).withOpacity(1.0);
    paint_6_stroke.strokeCap = StrokeCap.round;
    canvas.drawLine(
        Offset(size.width * 0.6482667, size.height * 0.3488250),
        Offset(size.width * 0.6091500, size.height * 0.3503250),
        paint_6_stroke);

    Paint paint_7_fill = Paint()..style = PaintingStyle.fill;
    paint_7_fill.color = Color(0xff292B50).withOpacity(1.0);
    canvas.drawCircle(Offset(size.width * 0.7917333, size.height * 0.7885500),
        size.width * 0.02613333, paint_7_fill);

    Paint paint_8_fill = Paint()..style = PaintingStyle.fill;
    paint_8_fill.color = Color(0xffF7B767).withOpacity(1.0);
    canvas.drawCircle(Offset(size.width * 0.7917333, size.height * 0.7885500),
        size.width * 0.01671667, paint_8_fill);

    Paint paint_9_fill = Paint()..style = PaintingStyle.fill;
    paint_9_fill.color = Color(0xff292B50).withOpacity(1.0);
    canvas.drawCircle(Offset(size.width * 0.7917333, size.height * 0.7885500),
        size.width * 0.01168333, paint_9_fill);

    Paint paint_10_stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.01103083;
    paint_10_stroke.color = Color(0xffFFFFFF).withOpacity(1.0);
    canvas.drawOval(
        Rect.fromCenter(
    ...
    Path path_11 = Path();
    path_11.moveTo(size.width * 0.7917333, size.height * 0.5757500);
    path_11.cubicTo(
    ...
    paint_11_stroke.color = Color(0xffF7B767).withOpacity(1.0);
    paint_11_stroke.strokeCap = StrokeCap.round;
    canvas.drawPath(path_11, paint_11_stroke);

    Paint paint_12_fill = Paint()..style = PaintingStyle.fill;
    paint_12_fill.color = Color(0xff292B50).withOpacity(1.0);
    canvas.drawCircle(Offset(size.width * 0.3453833, size.height * 0.7885500),
        size.width * 0.02613333, paint_12_fill);

    Paint paint_13_fill = Paint()..style = PaintingStyle.fill;
    paint_13_fill.color = Color(0xffF7B767).withOpacity(1.0);
    canvas.drawCircle(Offset(size.width * 0.3453833, size.height * 0.7885500),
        size.width * 0.01671667, paint_13_fill);

    Paint paint_14_fill = Paint()..style = PaintingStyle.fill;
    paint_14_fill.color = Color(0xff292B50).withOpacity(1.0);
    canvas.drawCircle(Offset(size.width * 0.3453833, size.height * 0.7885500),
        size.width * 0.01100000, paint_14_fill);

    Paint paint_15_stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.01103083;
    paint_15_stroke.color = Color(0xffFFFFFF).withOpacity(1.0);
    canvas.drawOval(
        Rect.fromCenter(
    ...
    Path path_16 = Path();
    path_16.moveTo(size.width * 0.4871000, size.height * 0.7885500);
    path_16.cubicTo(
    ...
    paint_16_stroke.color = Color(0xffF7B767).withOpacity(1.0);
    ...
    Paint paint_17_stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.01103083;
    paint_17_stroke.color = Color(0xffFFFFFF).withOpacity(1.0);
    canvas.drawLine(
        Offset(size.width * 0.6141833, size.height * 0.6346000),
        Offset(size.width * 0.6272000, size.height * 0.6566000),
        paint_17_stroke);

    Path path_18 = Path();
    path_18.moveTo(size.width * 0.5262000, size.height * 0.7152500);
    path_18.cubicTo(
    ...
    Paint paint_18_stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.01103083;
    paint_18_stroke.color = Color(0xffFFFFFF).withOpacity(1.0);
    canvas.drawPath(path_18, paint_18_stroke);

    Path path_19 = Path();
    path_19.moveTo(size.width * 0.6641833, size.height * 0.3861750);
    path_19.lineTo(size.width * 0.7865333, size.height * 0.7920750);
    path_19.cubicTo(
    ...
    path_19.lineTo(size.width * 0.6745333, size.height * 0.3791500);
    path_19.lineTo(size.width * 0.6641833, size.height * 0.3861750);
    path_19.close();

    Paint paint_19_fill = Paint()..style = PaintingStyle.fill;
    paint_19_fill.color = Color(0xffF7B767).withOpacity(1.0);
    canvas.drawPath(path_19, paint_19_fill);

    Paint paint_20_stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.01247633;
    paint_20_stroke.color = Color(0xffF7B767).withOpacity(1.0);
    paint_20_stroke.strokeCap = StrokeCap.round;
    canvas.drawLine(
        Offset(size.width * 0.5484667, size.height * 0.7972250),
        Offset(size.width * 0.4543500, size.height * 0.4934250),
        paint_20_stroke);

    Path path_21 = Path();
    path_21.moveTo(size.width * 0.4854667, size.height * 0.6042000);
    path_21.lineTo(size.width * 0.3453833, size.height * 0.7885500);
    path_21.lineTo(size.width * 0.5383333, size.height * 0.7885500);
    path_21.lineTo(size.width * 0.7164333, size.height * 0.5401250);

    Paint paint_21_stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.01247633;
    paint_21_stroke.color = Color(0xffF7B767).withOpacity(1.0);
    ...
    paint_22_fill.color = Color(0xff292B50).withOpacity(1.0);
    canvas.drawCircle(Offset(size.width * 0.5455667, size.height * 0.7866500),
        size.width * 0.01493333, paint_22_fill);

    Paint paint_23_stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.005372167;
    paint_23_stroke.color = Color(0xff292B50).withOpacity(1.0);
    canvas.drawCircle(Offset(size.width * 0.5455667, size.height * 0.7866500),
        size.width * 0.03146667, paint_23_stroke);

    Path path_24 = Path();
    path_24.moveTo(size.width * 0.4546833, size.height * 0.4912500);
    path_24.lineTo(size.width * 0.4188667, size.height * 0.4912500);
    path_24.cubicTo(
    ...
    path_24.lineTo(size.width * 0.4090667, size.height * 0.4662750);

    Paint paint_24_stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.003581500;
    paint_24_stroke.color = Color(0xffF7B767).withOpacity(1.0);
    paint_24_stroke.strokeCap = StrokeCap.round;
    canvas.drawPath(path_24, paint_24_stroke);

    Path path_25 = Path();
    path_25.moveTo(size.width * 0.4655667, size.height * 0.4847250);
    path_25.lineTo(size.width * 0.3973167, size.height * 0.4847250);
    path_25.cubicTo(
    ...
    path_25.lineTo(size.width * 0.3763167, size.height * 0.4532250);
    path_25.lineTo(size.width * 0.4655667, size.height * 0.4532250);
    path_25.cubicTo(
    ...
    path_25.lineTo(size.width * 0.4760667, size.height * 0.4689750);
    path_25.cubicTo(
        size.width * 0.4760667,
    ...
    Paint paint_26_stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.003581500;
    paint_26_stroke.color = Color(0xffFFFFFF).withOpacity(1.0);
    paint_26_stroke.strokeCap = StrokeCap.round;
    canvas.drawLine(
        Offset(size.width * 0.5455667, size.height * 0.7866500),
        Offset(size.width * 0.5858000, size.height * 0.8900750),
        paint_26_stroke);

    Path path_27 = Path();
    path_27.moveTo(size.width * 0.6227667, size.height * 0.9030000);
    path_27.lineTo(size.width * 0.5560167, size.height * 0.9030000);
    path_27.cubicTo(
    ...
    path_27.lineTo(size.width * 0.5541833, size.height * 0.8896250);
    path_27.cubicTo(
        size.width * 0.5541833,
        ...
        size.height * 0.8868750);
    path_27.lineTo(size.width * 0.6227667, size.height * 0.8868750);
    path_27.cubicTo(
    ...
    path_27.lineTo(size.width * 0.6246000, size.height * 0.9002500);
    path_27.cubicTo(
        size.width * 0.6246000,
        size.height * 0.9017750,
        size.width * 0.6237833,
    ...
    paint_27_fill.color = Color(0xff292B50).withOpacity(1.0);
    canvas.drawPath(path_27, paint_27_fill);

    Path path_28 = Path();
    path_28.moveTo(size.width * 0.3267667, size.height * 0.9566750);
    path_28.cubicTo(
    ...
    path_28.lineTo(size.width * 0.1867167, size.height * 0.9567250);
    path_28.lineTo(size.width * 0.3267667, size.height * 0.9567250);
    path_28.close();

    Paint paint_28_fill = Paint()..style = PaintingStyle.fill;
    paint_28_fill.color = Color(0xffD2A866).withOpacity(1.0);
    canvas.drawPath(path_28, paint_28_fill);

    Path path_29 = Path();
    path_29.moveTo(size.width * 0.8235333, size.height * 0.9566750);
    path_29.cubicTo(
    ...
    path_29.lineTo(size.width * 0.9497000, size.height * 0.9566750);
    path_29.lineTo(size.width * 0.8235333, size.height * 0.9566750);
    path_29.close();

    Paint paint_29_fill = Paint()..style = PaintingStyle.fill;
    paint_29_fill.color = Color(0xffD2A866).withOpacity(1.0);
    canvas.drawPath(path_29, paint_29_fill);

    Path path_30 = Path();
    path_30.moveTo(size.width * 0.3475167, size.height * 0.6026750);
    path_30.cubicTo(
    ...
    path_30.cubicTo(
        ...
        size.width * 0.3475167,
        size.height * 0.6026750);
    path_30.moveTo(size.width * 0.3475167, size.height * 0.6441250);
    path_30.cubicTo(
    ...
    paint_30_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
    canvas.drawPath(path_30, paint_30_fill);

    Path path_31 = Path();
    path_31.moveTo(size.width * 0.3475167, size.height * 0.6269250);
    path_31.cubicTo(
    ...
    path_31.cubicTo(
        ...
        size.width * 0.3475167,
        size.height * 0.6269250);
    path_31.moveTo(size.width * 0.3475167, size.height * 0.6441250);
    path_31.cubicTo(
        size.width * 0.2946833,
        size.height * 0.6441250,
        size.width * 0.2518500,
    ...
    Path path_32 = Path();
    path_32.moveTo(size.width * 0.7917167, size.height * 0.6001250);
    path_32.cubicTo(
    ...
    path_32.cubicTo(
        ...
        size.width * 0.7917167,
        size.height * 0.6001250);
    path_32.moveTo(size.width * 0.7917167, size.height * 0.6415500);
    path_32.cubicTo(
    ...
    paint_32_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
    canvas.drawPath(path_32, paint_32_fill);

    Path path_33 = Path();
    path_33.moveTo(size.width * 0.7917167, size.height * 0.6243750);
    path_33.cubicTo(
    ...
    path_33.cubicTo(
        ...
        size.width * 0.7917167,
        size.height * 0.6243750);
    path_33.moveTo(size.width * 0.7917167, size.height * 0.6415500);
    path_33.cubicTo(
        size.width * 0.7388833,
        size.height * 0.6415500,
        size.width * 0.6960500,
    ...
    Path path_34 = Path();
    path_34.moveTo(size.width * 0.5261333, size.height * 0.7340000);
    path_34.cubicTo(
    ...
    path_34.cubicTo(
        ...
        size.height * 0.7546500);
    path_34.lineTo(size.width * 0.3639167, size.height * 0.7516500);
    path_34.lineTo(size.width * 0.3639167, size.height * 0.7542250);
    path_34.lineTo(size.width * 0.3463333, size.height * 0.7570750);
    path_34.cubicTo(
    ...
    path_34.lineTo(size.width * 0.3455667, size.height * 0.8174500);
    path_34.lineTo(size.width * 0.3455833, size.height * 0.8175250);
    path_34.cubicTo(
    ...
    path_34.lineTo(size.width * 0.3656667, size.height * 0.7541750);
    path_34.lineTo(size.width * 0.3656667, size.height * 0.7516000);
    path_34.lineTo(size.width * 0.5261333, size.height * 0.7340000);
    path_34.close();

    Paint paint_34_fill = Paint()..style = PaintingStyle.fill;
    paint_34_fill.color = Color(0xffFBB03B).withOpacity(1.0);
    canvas.drawPath(path_34, paint_34_fill);

    Path path_35 = Path();
    path_35.moveTo(size.width * 0.5664333, size.height * 0.9901750);
    path_35.cubicTo(
    ...
    paint_35_fill.color = Color(0xffD2A866).withOpacity(1.0);
    canvas.drawPath(path_35, paint_35_fill);

    Path path_36 = Path();
    path_36.moveTo(size.width * 0.4632500, size.height * 0.02877500);
    path_36.cubicTo(
    ...
    paint_36_fill.color = Color(0xff003B3A).withOpacity(1.0);
    canvas.drawPath(path_36, paint_36_fill);

    Path path_37 = Path();
    path_37.moveTo(size.width * 0.4650333, size.height * 0.02417500);
    path_37.cubicTo(
    ...
    paint_37_fill.color = Color(0xff003B3A).withOpacity(1.0);
    canvas.drawPath(path_37, paint_37_fill);

    Path path_38 = Path();
    path_38.moveTo(size.width * 0.4463833, size.height * 0.1021000);
    path_38.cubicTo(
    ...
    path_38.lineTo(size.width * 0.4463833, size.height * 0.1021000);
    path_38.close();

    Paint paint_38_fill = Paint()..style = PaintingStyle.fill;
    paint_38_fill.color = Color(0xff003B3A).withOpacity(1.0);
    canvas.drawPath(path_38, paint_38_fill);

    Path path_39 = Path();
    path_39.moveTo(size.width * 0.4366833, size.height * 0.2186250);
    path_39.cubicTo(
    ...
    paint_39_fill.color = Color(0xffFCD0B5).withOpacity(1.0);
    canvas.drawPath(path_39, paint_39_fill);

    Path path_40 = Path();
    path_40.moveTo(size.width * 0.5250833, size.height * 0.1872500);
    path_40.cubicTo(
    ...
    path_40.lineTo(size.width * 0.5250833, size.height * 0.1872500);
    path_40.close();

    Paint paint_40_fill = Paint()..style = PaintingStyle.fill;
    paint_40_fill.color = Color(0xffF7B767).withOpacity(1.0);
    canvas.drawPath(path_40, paint_40_fill);

    Path path_41 = Path();
    path_41.moveTo(size.width * 0.5240000, size.height * 0.1948000);
    path_41.lineTo(size.width * 0.5165667, size.height * 0.2670250);
    path_41.cubicTo(
    ...
    path_41.lineTo(size.width * 0.5240000, size.height * 0.1948000);
    path_41.close();

    Paint paint_41_fill = Paint()..style = PaintingStyle.fill;
    paint_41_fill.color = Color(0xffC56274).withOpacity(1.0);
    canvas.drawPath(path_41, paint_41_fill);

    Path path_42 = Path();
    path_42.moveTo(size.width * 0.5250833, size.height * 0.1872500);
    path_42.cubicTo(
        size.width * 0.5002333,
        size.height * 0.1943000,
        size.width * 0.4838333,
    ...
    path_42.cubicTo(
        ...
        size.width * 0.5060333,
        size.height * 0.2692000);
    path_42.lineTo(size.width * 0.5250833, size.height * 0.1872500);
    path_42.close();
    ...
    Path path_43 = Path();
    path_43.moveTo(size.width * 0.4348667, size.height * 0.1530500);
    path_43.cubicTo(
    ...
    path_43.lineTo(size.width * 0.4348667, size.height * 0.1530500);
    path_43.close();

    Paint paint_43_fill = Paint()..style = PaintingStyle.fill;
    paint_43_fill.color = Color(0xffFCF9F5).withOpacity(1.0);
    canvas.drawPath(path_43, paint_43_fill);

    Path path_44 = Path();
    path_44.moveTo(size.width * 0.4199333, size.height * 0.1710000);
    path_44.cubicTo(
    ...
    path_44.lineTo(size.width * 0.4199333, size.height * 0.1710000);
    path_44.close();

    Paint paint_44_fill = Paint()..style = PaintingStyle.fill;
    paint_44_fill.color = Color(0xffFCF9F5).withOpacity(1.0);
    canvas.drawPath(path_44, paint_44_fill);

    Path path_45 = Path();
    path_45.moveTo(size.width * 0.4150833, size.height * 0.1865500);
    path_45.cubicTo(
    ...
    path_45.lineTo(size.width * 0.4150833, size.height * 0.1865500);
    path_45.close();

    Paint paint_45_fill = Paint()..style = PaintingStyle.fill;
    paint_45_fill.color = Color(0xffFCF9F5).withOpacity(1.0);
    canvas.drawPath(path_45, paint_45_fill);

    Path path_46 = Path();
    path_46.moveTo(size.width * 0.4468667, size.height * 0.06740000);
    path_46.cubicTo(
    ...
    paint_46_fill.color = Color(0xffFCD0B5).withOpacity(1.0);
    canvas.drawPath(path_46, paint_46_fill);

    Path path_47 = Path();
    path_47.moveTo(size.width * 0.4761000, size.height * 0.1585000);
    path_47.cubicTo(
    ...
    path_47.cubicTo(
        ...
        size.width * 0.4795833,
        size.height * 0.1771000);
    path_47.lineTo(size.width * 0.4761000, size.height * 0.1585000);
    path_47.close();

    Paint paint_47_fill = Paint()..style = PaintingStyle.fill;
    paint_47_fill.color = Color(0xffD47082).withOpacity(1.0);
    canvas.drawPath(path_47, paint_47_fill);

    Path path_48 = Path();
    path_48.moveTo(size.width * 0.4899500, size.height * 0.09627500);
    path_48.lineTo(size.width * 0.4771833, size.height * 0.09332500);
    path_48.cubicTo(
    ...
    Path path_49 = Path();
    path_49.moveTo(size.width * 0.4448167, size.height * 0.07315000);
    path_49.cubicTo(
    ...
    paint_49_fill.color = Color(0xffD47082).withOpacity(1.0);
    canvas.drawPath(path_49, paint_49_fill);

    Path path_50 = Path();
    path_50.moveTo(size.width * 0.4860667, size.height * 0.08285000);
    path_50.lineTo(size.width * 0.4844000, size.height * 0.09235000);
    path_50.lineTo(size.width * 0.4878000, size.height * 0.09265000);
    path_50.cubicTo(
    ...
    path_50.lineTo(size.width * 0.4860667, size.height * 0.08285000);
    path_50.close();

    Paint paint_50_fill = Paint()..style = PaintingStyle.fill;
    paint_50_fill.color = Color(0xffD47082).withOpacity(1.0);
    canvas.drawPath(path_50, paint_50_fill);

    Path path_51 = Path();
    path_51.moveTo(size.width * 0.4840000, size.height * 0.03707500);
    path_51.cubicTo(
    ...
    paint_51_fill.color = Color(0xff003B3A).withOpacity(1.0);
    canvas.drawPath(path_51, paint_51_fill);

    Path path_52 = Path();
    path_52.moveTo(size.width * 0.4723333, size.height * 0.1204250);
    path_52.cubicTo(
    ...
    paint_52_fill.color = Color(0xffD47082).withOpacity(1.0);
    canvas.drawPath(path_52, paint_52_fill);

    Path path_53 = Path();
    path_53.moveTo(size.width * 0.4776000, size.height * 0.06740000);
    path_53.cubicTo(
    ...
    paint_53_fill.color = Color(0xff003B3A).withOpacity(1.0);
    canvas.drawPath(path_53, paint_53_fill);

    Path path_54 = Path();
    path_54.moveTo(size.width * 0.4932333, size.height * 0.06610000);
    path_54.cubicTo(
    ...
    paint_54_fill.color = Color(0xff003B3A).withOpacity(1.0);
    canvas.drawPath(path_54, paint_54_fill);

    Path path_55 = Path();
    path_55.moveTo(size.width * 0.4806500, size.height * 0.08030000);
    path_55.cubicTo(
    ...
    paint_55_fill.color = Color(0xff003B3A).withOpacity(1.0);
    canvas.drawPath(path_55, paint_55_fill);

    Path path_56 = Path();
    path_56.moveTo(size.width * 0.4885833, size.height * 0.08142500);
    path_56.cubicTo(
    ...
    paint_56_fill.color = Color(0xff003B3A).withOpacity(1.0);
    canvas.drawPath(path_56, paint_56_fill);

    Path path_57 = Path();
    path_57.moveTo(size.width * 0.4620000, size.height * 0.09167500);
    path_57.cubicTo(
    ...
    paint_57_stroke.color = Color(0xffFF5E6E).withOpacity(1.0);
    canvas.drawPath(path_57, paint_57_stroke);

    Paint paint_57_fill = Paint()..style = PaintingStyle.fill;
    paint_57_fill.color = Color(0xffFF5E6E).withOpacity(1.0);
    canvas.drawPath(path_57, paint_57_fill);

    Path path_58 = Path();
    path_58.moveTo(size.width * 0.4971333, size.height * 0.07947500);
    path_58.cubicTo(
    ...
    paint_58_stroke.color = Color(0xffF7B767).withOpacity(1.0);
    canvas.drawPath(path_58, paint_58_stroke);

    Paint paint_58_fill = Paint()..style = PaintingStyle.fill;
    paint_58_fill.color = Color(0xff003B3A).withOpacity(1.0);
    canvas.drawPath(path_58, paint_58_fill);

    Paint paint_59_stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.002369833;
    paint_59_stroke.color = Color(0xffF7B767).withOpacity(1.0);
    canvas.drawOval(
        Rect.fromCenter(
    ...
    paint_59_fill.color = Color(0xff003B3A).withOpacity(1.0);
    canvas.drawOval(
        Rect.fromCenter(
            center: Offset(size.width * 0.4791667, size.height * 0.07722500),
            width: size.width * 0.02176667,
    ...
    Paint paint_60_stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.002369833;
    paint_60_stroke.color = Color(0xffF7B767).withOpacity(1.0);
    ...
    Path path_61 = Path();
    path_61.moveTo(size.width * 0.4769167, size.height * 0.1624000);
    path_61.cubicTo(
    ...
    paint_61_stroke.color = Color(0xffFFB09E).withOpacity(1.0);
    ...
    paint_61_fill.color = Color(0xffFFB09E).withOpacity(1.0);
    canvas.drawPath(path_61, paint_61_fill);

    Path path_62 = Path();
    path_62.moveTo(size.width * 0.4769167, size.height * 0.1624000);
    path_62.cubicTo(
        size.width * 0.4783833,
        size.height * 0.1643750,
        size.width * 0.5001000,
    ...
    paint_62_fill.color = Color(0xffF7B767).withOpacity(1.0);
    canvas.drawPath(path_62, paint_62_fill);

    Path path_63 = Path();
    path_63.moveTo(size.width * 0.4769167, size.height * 0.1624000);
    path_63.cubicTo(
        size.width * 0.4783833,
        size.height * 0.1643750,
        size.width * 0.5001000,
    ...
    Path path_64 = Path();
    path_64.moveTo(size.width * 0.4139333, size.height * 0.3202000);
    path_64.cubicTo(
    ...
    path_64.lineTo(size.width * 0.4139333, size.height * 0.3202000);
    path_64.close();

    Paint paint_64_fill = Paint()..style = PaintingStyle.fill;
    paint_64_fill.color = Color(0xffFCF9F5).withOpacity(1.0);
    canvas.drawPath(path_64, paint_64_fill);

    Path path_65 = Path();
    path_65.moveTo(size.width * 0.4321000, size.height * 0.3252000);
    path_65.cubicTo(
    ...
    path_65.lineTo(size.width * 0.4321000, size.height * 0.3252000);
    path_65.close();

    Paint paint_65_fill = Paint()..style = PaintingStyle.fill;
    paint_65_fill.color = Color(0xffFCF9F5).withOpacity(1.0);
    canvas.drawPath(path_65, paint_65_fill);

    Path path_66 = Path();
    path_66.moveTo(size.width * 0.4503667, size.height * 0.3281000);
    path_66.cubicTo(
    ...
    path_66.cubicTo(
        ...
        size.height * 0.3281000);
    path_66.lineTo(size.width * 0.4503667, size.height * 0.3281000);
    path_66.close();

    Paint paint_66_fill = Paint()..style = PaintingStyle.fill;
    paint_66_fill.color = Color(0xffFCF9F5).withOpacity(1.0);
    canvas.drawPath(path_66, paint_66_fill);

    Path path_67 = Path();
    path_67.moveTo(size.width * 0.4742833, size.height * 0.3369000);
    path_67.cubicTo(
    ...
    path_67.lineTo(size.width * 0.4742833, size.height * 0.3369000);
    path_67.close();

    Paint paint_67_fill = Paint()..style = PaintingStyle.fill;
    paint_67_fill.color = Color(0xffFCF9F5).withOpacity(1.0);
    canvas.drawPath(path_67, paint_67_fill);

    Path path_68 = Path();
    path_68.moveTo(size.width * 0.4957333, size.height * 0.3405500);
    path_68.cubicTo(
    ...
    path_68.lineTo(size.width * 0.4957333, size.height * 0.3405500);
    path_68.close();

    Paint paint_68_fill = Paint()..style = PaintingStyle.fill;
    paint_68_fill.color = Color(0xffFCF9F5).withOpacity(1.0);
    canvas.drawPath(path_68, paint_68_fill);

    Path path_69 = Path();
    path_69.moveTo(size.width * 0.6073667, size.height * 0.3565000);
    path_69.lineTo(size.width * 0.5767833, size.height * 0.3598750);
    path_69.cubicTo(
    ...
    path_69.lineTo(size.width * 0.6068167, size.height * 0.3295250);
    path_69.cubicTo(
    ...
    paint_69_fill.color = Color(0xffFCD0B5).withOpacity(1.0);
    canvas.drawPath(path_69, paint_69_fill);

    Path path_70 = Path();
    path_70.moveTo(size.width * 0.5096500, size.height * 0.2791750);
    path_70.cubicTo(
    ...
    path_70.cubicTo(
        ...
        size.height * 0.2961750);
    path_70.lineTo(size.width * 0.5096500, size.height * 0.2791750);
    path_70.close();

    Paint paint_70_fill = Paint()..style = PaintingStyle.fill;
    paint_70_fill.color = Color(0xffF7B767).withOpacity(1.0);
    canvas.drawPath(path_70, paint_70_fill);

    Path path_71 = Path();
    path_71.moveTo(size.width * 0.5096500, size.height * 0.2791750);
    path_71.cubicTo(
        size.width * 0.4881167,
        size.height * 0.2563500,
        size.width * 0.4783333,
    ...
    path_71.cubicTo(
        ...
        size.width * 0.4522333,
        size.height * 0.2961750);
    path_71.lineTo(size.width * 0.5096500, size.height * 0.2791750);
    path_71.close();
    ...
    Path path_72 = Path();
    path_72.moveTo(size.width * 0.4234500, size.height * 0.1624500);
    path_72.cubicTo(
    ...
    path_72.lineTo(size.width * 0.4234500, size.height * 0.1624500);
    path_72.close();

    Paint paint_72_fill = Paint()..style = PaintingStyle.fill;
    paint_72_fill.color = Color(0xffFCF9F5).withOpacity(1.0);
    canvas.drawPath(path_72, paint_72_fill);

    Path path_73 = Path();
    path_73.moveTo(size.width * 0.4345333, size.height * 0.1559750);
    path_73.cubicTo(
    ...
    path_73.cubicTo(
        ...
        size.height * 0.1559750);
    path_73.lineTo(size.width * 0.4345333, size.height * 0.1559750);
    path_73.close();

    Paint paint_73_fill = Paint()..style = PaintingStyle.fill;
    paint_73_fill.color = Color(0xffFCF9F5).withOpacity(1.0);
    canvas.drawPath(path_73, paint_73_fill);

    Path path_74 = Path();
    path_74.moveTo(size.width * 0.4484833, size.height * 0.1585500);
    path_74.cubicTo(
    ...
    path_74.lineTo(size.width * 0.4484833, size.height * 0.1585500);
    path_74.close();

    Paint paint_74_fill = Paint()..style = PaintingStyle.fill;
    paint_74_fill.color = Color(0xffFCF9F5).withOpacity(1.0);
    canvas.drawPath(path_74, paint_74_fill);

    Path path_75 = Path();
    path_75.moveTo(size.width * 0.5004333, size.height * 0.2840750);
    path_75.lineTo(size.width * 0.4807167, size.height * 0.3176000);
    path_75.cubicTo(
    ...
    path_75.lineTo(size.width * 0.5004333, size.height * 0.2840750);
    path_75.close();

    Paint paint_75_fill = Paint()..style = PaintingStyle.fill;
    paint_75_fill.color = Color(0xffD47082).withOpacity(1.0);
    canvas.drawPath(path_75, paint_75_fill);

    Path path_76 = Path();
    path_76.moveTo(size.width * 0.5708000, size.height * 0.7952250);
    path_76.cubicTo(
        ...
        size.width * 0.5677167,
        size.height * 0.8744000);
    path_76.lineTo(size.width * 0.6326833, size.height * 0.8816000);
    path_76.cubicTo(
        ...
        size.width * 0.5984500,
        size.height * 0.8416250);
    path_76.lineTo(size.width * 0.5893833, size.height * 0.7974000);
    path_76.cubicTo(
    ...
    paint_76_fill.color = Color(0xffFFB09E).withOpacity(1.0);
    canvas.drawPath(path_76, paint_76_fill);

    Path path_77 = Path();
    path_77.moveTo(size.width * 0.5986167, size.height * 0.8416750);
    path_77.lineTo(size.width * 0.6336500, size.height * 0.8806000);
    path_77.cubicTo(
    ...
    paint_77_fill.color = Color(0xffE26191).withOpacity(1.0);
    canvas.drawPath(path_77, paint_77_fill);

    Path path_78 = Path();
    path_78.moveTo(size.width * 0.6007167, size.height * 0.8437250);
    path_78.lineTo(size.width * 0.5937500, size.height * 0.8545500);
    path_78.cubicTo(
        ...
        size.height * 0.8637000);
    path_78.lineTo(size.width * 0.5938667, size.height * 0.8637000);
    path_78.cubicTo(
    ...
    path_78.lineTo(size.width * 0.6077833, size.height * 0.8513750);

    Paint paint_78_stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.001527000;
    paint_78_stroke.color = Color(0xffFCF9F5).withOpacity(1.0);
    canvas.drawPath(path_78, paint_78_stroke);

    Path path_79 = Path();
    path_79.moveTo(size.width * 0.5649667, size.height * 0.7966500);
    path_79.lineTo(size.width * 0.5685833, size.height * 0.8333500);
    path_79.cubicTo(
        size.width * 0.5685833,
        size.height * 0.8333500,
    ...
    path_79.cubicTo(
        ...
        size.width * 0.5755167,
        size.height * 0.7981000);
    path_79.lineTo(size.width * 0.5649667, size.height * 0.7966500);
    path_79.close();

    Paint paint_79_fill = Paint()..style = PaintingStyle.fill;
    paint_79_fill.color = Color(0xffD47082).withOpacity(1.0);
    canvas.drawPath(path_79, paint_79_fill);

    Path path_80 = Path();
    path_80.moveTo(size.width * 0.4145333, size.height * 0.3288250);
    path_80.cubicTo(
    ...
    path_80.lineTo(size.width * 0.6061667, size.height * 0.8175000);
    path_80.cubicTo(
    ...
    path_80.cubicTo(
        ...
        size.width * 0.4739333,
        size.height * 0.3417750);
    path_80.lineTo(size.width * 0.4145333, size.height * 0.3288250);
    path_80.close();

    Paint paint_80_fill = Paint()..style = PaintingStyle.fill;
    paint_80_fill.color = Color(0xff419355).withOpacity(1.0);
    canvas.drawPath(path_80, paint_80_fill);

    Path path_81 = Path();
    path_81.moveTo(size.width * 0.4145333, size.height * 0.3288250);
    path_81.cubicTo(
        size.width * 0.4145333,
        size.height * 0.3288250,
        size.width * 0.3857833,
    ...
    path_81.cubicTo(
        ...
        size.width * 0.5659167,
        size.height * 0.8203750);
    path_81.lineTo(size.width * 0.6061667, size.height * 0.8175000);
    path_81.cubicTo(
        size.width * 0.6061667,
        size.height * 0.8175000,
    ...
    paint_81_fill.color = Color(0xff357843).withOpacity(1.0);
    canvas.drawPath(path_81, paint_81_fill);

    Path path_82 = Path();
    path_82.moveTo(size.width * 0.4416000, size.height * 0.09902500);
    path_82.cubicTo(
    ...
    paint_82_fill.color = Color(0xff003B3A).withOpacity(1.0);
    canvas.drawPath(path_82, paint_82_fill);

    Path path_83 = Path();
    path_83.moveTo(size.width * 0.4385333, size.height * 0.1017000);
    path_83.cubicTo(
    ...
    path_83.lineTo(size.width * 0.4385333, size.height * 0.1017000);
    path_83.close();

    Paint paint_83_fill = Paint()..style = PaintingStyle.fill;
    paint_83_fill.color = Color(0xff003B3A).withOpacity(1.0);
    canvas.drawPath(path_83, paint_83_fill);

    Path path_84 = Path();
    path_84.moveTo(size.width * 0.4702333, size.height * 0.6139250);
    path_84.lineTo(size.width * 0.4774333, size.height * 0.6248250);
    path_84.cubicTo(
    ...
    path_84.lineTo(size.width * 0.4729000, size.height * 0.6339500);
    path_84.cubicTo(
    ...
    path_84.lineTo(size.width * 0.4620500, size.height * 0.6244250);
    path_84.cubicTo(
        size.width * 0.4614000,
    ...
    path_84.lineTo(size.width * 0.4665833, size.height * 0.6153000);
    path_84.cubicTo(
        size.width * 0.4679333,
...
//   void paint(Canvas canvas, Size size) {
//     Path path_0 = Path();
//     path_0.moveTo(size.width * 0.9412000, size.height * 0.7485000);
//     path_0.lineTo(size.width * 0.5520178, size.height * 0.7485000);
//     path_0.cubicTo(
...
//     Paint paint_0_fill = Paint()..style = PaintingStyle.fill;
//     paint_0_fill.color = Color(0xffC8A96F).withOpacity(1.0);
//     canvas.drawPath(path_0, paint_0_fill);

//     Path path_1 = Path();
//     path_1.moveTo(size.width * 0.6511911, size.height * 0.1898000);
//     path_1.cubicTo(
...
//     Paint paint_1_fill = Paint()..style = PaintingStyle.fill;
//     paint_1_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_1, paint_1_fill);

//     Path path_2 = Path();
//     path_2.moveTo(size.width * 0.9210311, size.height * 0.5571500);
//     path_2.lineTo(size.width * 0.9210311, size.height * 0.4367000);
//     path_2.lineTo(size.width * 0.8922222, size.height * 0.4367000);
//     path_2.lineTo(size.width * 0.8922222, size.height * 0.2714500);
//     path_2.lineTo(size.width * 0.8514578, size.height * 0.2714500);
//     path_2.lineTo(size.width * 0.8514578, size.height * 0.3935250);
//     path_2.lineTo(size.width * 0.8389511, size.height * 0.3935250);
//     path_2.lineTo(size.width * 0.8389511, size.height * 0.2019750);
//     path_2.lineTo(size.width * 0.8052533, size.height * 0.2019750);
//     path_2.lineTo(size.width * 0.8052533, size.height * 0.3578250);
//     path_2.lineTo(size.width * 0.7943822, size.height * 0.3578250);
//     path_2.lineTo(size.width * 0.7943822, size.height * 0.2564250);
//     path_2.lineTo(size.width * 0.7670578, size.height * 0.2564250);
//     path_2.lineTo(size.width * 0.7670578, size.height * 0.4461000);
//     path_2.lineTo(size.width * 0.7503556, size.height * 0.4461000);
//     path_2.lineTo(size.width * 0.7503556, size.height * 0.4066750);
//     path_2.lineTo(size.width * 0.7296978, size.height * 0.4066750);
//     path_2.lineTo(size.width * 0.7296978, size.height * 0.3899000);
//     path_2.lineTo(size.width * 0.6889333, size.height * 0.3899000);
//     path_2.lineTo(size.width * 0.6889333, size.height * 0.4821250);
//     path_2.lineTo(size.width * 0.6764444, size.height * 0.4821250);
//     path_2.lineTo(size.width * 0.6764444, size.height * 0.3374000);
//     path_2.lineTo(size.width * 0.6427467, size.height * 0.3374000);
//     path_2.lineTo(size.width * 0.6427467, size.height * 0.4551750);
//     path_2.lineTo(size.width * 0.6318756, size.height * 0.4551750);
//     path_2.lineTo(size.width * 0.6318756, size.height * 0.3785000);
//     path_2.lineTo(size.width * 0.6045511, size.height * 0.3785000);
//     path_2.lineTo(size.width * 0.6045511, size.height * 0.5218000);
//     path_2.lineTo(size.width * 0.5878489, size.height * 0.5218000);
//     path_2.lineTo(size.width * 0.5878489, size.height * 0.4920000);
//     path_2.lineTo(size.width * 0.5579556, size.height * 0.4920000);
//     path_2.lineTo(size.width * 0.5579556, size.height * 0.5955750);
//     path_2.lineTo(size.width * 0.5367556, size.height * 0.5955750);
//     path_2.lineTo(size.width * 0.5367556, size.height * 0.5643500);
//     path_2.lineTo(size.width * 0.5161333, size.height * 0.5643500);
//     path_2.cubicTo(
...
//     path_2.lineTo(size.width * 0.9512978, size.height * 0.7484750);
//     path_2.cubicTo(
...
//     path_2.lineTo(size.width * 0.9600711, size.height * 0.5571250);
//     path_2.lineTo(size.width * 0.9210311, size.height * 0.5571250);
//     path_2.close();

//     Paint paint_2_fill = Paint()..style = PaintingStyle.fill;
//     paint_2_fill.color = Color(0xffE0E3E4).withOpacity(1.0);
//     canvas.drawPath(path_2, paint_2_fill);

//     Path path_3 = Path();
//     path_3.moveTo(size.width * 0.5238667, size.height * 0.7483750);
//     path_3.lineTo(size.width * 0.9811022, size.height * 0.7483750);
//     path_3.cubicTo(
...
//         size.height * 0.7559250);
//     path_3.lineTo(size.width * 0.5238667, size.height * 0.7559250);
//     path_3.cubicTo(
...
//     Paint paint_3_fill = Paint()..style = PaintingStyle.fill;
//     paint_3_fill.color = Color(0xffD2A866).withOpacity(1.0);
//     canvas.drawPath(path_3, paint_3_fill);

//     Paint paint_4_fill = Paint()..style = PaintingStyle.fill;
//     paint_4_fill.color = Color(0xffFAFFFF).withOpacity(1.0);
//     canvas.drawRect(
...
//     paint_5_fill.color = Color(0xff3A3C61).withOpacity(1.0);
//     canvas.drawRect(
...
//     Path path_6 = Path();
//     path_6.moveTo(size.width * 0.9218756, size.height * 0.1792750);
//     path_6.lineTo(size.width * 0.9323822, size.height * 0.1792750);
//     path_6.cubicTo(
...
//     path_6.lineTo(size.width * 0.9337067, size.height * 0.1867250);
//     path_6.lineTo(size.width * 0.9205511, size.height * 0.1867250);
//     path_6.lineTo(size.width * 0.9205511, size.height * 0.1830000);
//     path_6.cubicTo(
...
//     paint_6_fill.color = Color(0xff352A54).withOpacity(1.0);
//     canvas.drawPath(path_6, paint_6_fill);

//     Paint paint_7_fill = Paint()..style = PaintingStyle.fill;
//     paint_7_fill.color = Color(0xff3A3C61).withOpacity(1.0);
//     canvas.drawRect(
...
//     Paint paint_9_fill = Paint()..style = PaintingStyle.fill;
//     paint_9_fill.color = Color(0xff3A3C61).withOpacity(1.0);
//     canvas.drawRect(
...
//     Path path_10 = Path();
//     path_10.moveTo(size.width * 0.6270844, size.height * 0.7483750);
//     path_10.cubicTo(
...
//     path_10.lineTo(size.width * 0.5542311, size.height * 0.7483250);
//     path_10.lineTo(size.width * 0.6270844, size.height * 0.7483250);
//     path_10.close();

//     Paint paint_10_fill = Paint()..style = PaintingStyle.fill;
//     paint_10_fill.color = Color(0xffD2A866).withOpacity(1.0);
//     canvas.drawPath(path_10, paint_10_fill);

//     Path path_11 = Path();
//     path_11.moveTo(size.width * 0.8855556, size.height * 0.7483750);
//     path_11.cubicTo(
...
//     path_11.lineTo(size.width * 0.9511911, size.height * 0.7483500);
//     path_11.lineTo(size.width * 0.8855556, size.height * 0.7483500);
//     path_11.close();

//     Paint paint_11_fill = Paint()..style = PaintingStyle.fill;
//     paint_11_fill.color = Color(0xffD2A866).withOpacity(1.0);
//     canvas.drawPath(path_11, paint_11_fill);

//     Paint paint_12_fill = Paint()..style = PaintingStyle.fill;
//     paint_12_fill.color = Color(0xffD6F0FF).withOpacity(1.0);
//     canvas.drawRect(
...
//     Paint paint_13_fill = Paint()..style = PaintingStyle.fill;
//     paint_13_fill.color = Color(0xff3A3C61).withOpacity(1.0);
//     canvas.drawRect(
...
//     Path path_14 = Path();
//     path_14.moveTo(size.width * 0.5661778, size.height * 0.1792750);
//     path_14.lineTo(size.width * 0.5766844, size.height * 0.1792750);
//     path_14.cubicTo(
...
//         size.width * 0.5780089,
//         size.height * 0.1830000);
//     path_14.lineTo(size.width * 0.5780089, size.height * 0.1867250);
//     path_14.lineTo(size.width * 0.5648533, size.height * 0.1867250);
//     path_14.lineTo(size.width * 0.5648533, size.height * 0.1830000);
//     path_14.cubicTo(
...
//     Paint paint_14_fill = Paint()..style = PaintingStyle.fill;
//     paint_14_fill.color = Color(0xff352A54).withOpacity(1.0);
//     canvas.drawPath(path_14, paint_14_fill);

//     Paint paint_15_fill = Paint()..style = PaintingStyle.fill;
//     paint_15_fill.color = Color(0xff3A3C61).withOpacity(1.0);
//     canvas.drawRect(
...
//     paint_17_fill.color = Color(0xff3A3C61).withOpacity(1.0);
//     canvas.drawRect(
...
//     Path path_18 = Path();
//     path_18.moveTo(size.width * 0.5195644, size.height * 0.8947250);
//     path_18.cubicTo(
...
//     paint_18_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_18, paint_18_fill);

//     Path path_19 = Path();
//     path_19.moveTo(size.width * 0.5470933, size.height * 0.8421000);
//     path_19.cubicTo(
...
//     Paint paint_19_fill = Paint()..style = PaintingStyle.fill;
//     paint_19_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_19, paint_19_fill);

//     Path path_20 = Path();
//     path_20.moveTo(size.width * 0.5391644, size.height * 0.9541500);
//     path_20.cubicTo(
...
//     paint_20_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_20, paint_20_fill);

//     Path path_21 = Path();
//     path_21.moveTo(size.width * 0.5965422, size.height * 0.9120750);
//     path_21.cubicTo(
...
//     paint_21_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_21, paint_21_fill);

//     Path path_22 = Path();
//     path_22.moveTo(size.width * 0.5953422, size.height * 0.9719250);
//     path_22.cubicTo(
...
//     Paint paint_22_fill = Paint()..style = PaintingStyle.fill;
//     paint_22_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_22, paint_22_fill);

//     Path path_23 = Path();
//     path_23.moveTo(size.width * 0.6224533, size.height * 0.9348250);
//     path_23.cubicTo(
...
//     paint_23_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_23, paint_23_fill);

//     Path path_24 = Path();
//     path_24.moveTo(size.width * 0.6518222, size.height * 0.9683500);
//     path_24.cubicTo(
...
//     paint_24_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_24, paint_24_fill);

//     Path path_25 = Path();
//     path_25.moveTo(size.width * 0.6888711, size.height * 0.9240500);
//     path_25.cubicTo(
...
//     Paint paint_25_fill = Paint()..style = PaintingStyle.fill;
//     paint_25_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_25, paint_25_fill);

//     Path path_26 = Path();
//     path_26.moveTo(size.width * 0.6970044, size.height * 0.9025000);
//     path_26.cubicTo(
...
//     paint_26_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_26, paint_26_fill);

//     Path path_27 = Path();
//     path_27.moveTo(size.width * 0.7277333, size.height * 0.9875000);
//     path_27.cubicTo(
...
//     Paint paint_27_fill = Paint()..style = PaintingStyle.fill;
//     paint_27_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_27, paint_27_fill);

//     Path path_28 = Path();
//     path_28.moveTo(size.width * 0.7661422, size.height * 0.9312250);
//     path_28.cubicTo(
...
//     Paint paint_28_fill = Paint()..style = PaintingStyle.fill;
//     paint_28_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_28, paint_28_fill);

//     Path path_29 = Path();
//     path_29.moveTo(size.width * 0.7837600, size.height * 0.8737750);
//     path_29.cubicTo(
...
//     Paint paint_29_fill = Paint()..style = PaintingStyle.fill;
//     paint_29_fill.color = Color(0xffB6DBF7).withOpacity(1.0);
//     canvas.drawPath(path_29, paint_29_fill);

//     Path path_30 = Path();
//     path_30.moveTo(size.width * 0.7748800, size.height * 0.8300500);
//     path_30.cubicTo(
...
//     Path path_31 = Path();
//     path_31.moveTo(size.width * 0.8348178, size.height * 0.9312250);
//     path_31.cubicTo(
...
//     Paint paint_31_fill = Paint()..style = PaintingStyle.fill;
//     paint_31_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_31, paint_31_fill);

//     Path path_32 = Path();
//     path_32.moveTo(size.width * 0.8718667, size.height * 0.9827000);
//     path_32.cubicTo(
...
//     Path path_33 = Path();
//     path_33.moveTo(size.width * 0.9025956, size.height * 0.9493500);
//     path_33.cubicTo(
...
//     Paint paint_33_fill = Paint()..style = PaintingStyle.fill;
//     paint_33_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_33, paint_33_fill);

//     Path path_34 = Path();
//     path_34.moveTo(size.width * 0.9423556, size.height * 0.9194250);
//     path_34.cubicTo(
...
//     Paint paint_34_fill = Paint()..style = PaintingStyle.fill;
//     paint_34_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_34, paint_34_fill);

//     Path path_35 = Path();
//     path_35.moveTo(size.width * 0.9649689, size.height * 0.8700000);
//     path_35.cubicTo(
...
//     Paint paint_35_fill = Paint()..style = PaintingStyle.fill;
//     paint_35_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_35, paint_35_fill);

//     Path path_36 = Path();
//     path_36.moveTo(size.width * 0.9298222, size.height * 0.8296250);
//     path_36.cubicTo(
...
//     Paint paint_36_fill = Paint()..style = PaintingStyle.fill;
//     paint_36_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_36, paint_36_fill);

//     Path path_37 = Path();
//     path_37.moveTo(size.width * 0.7500622, size.height * 0.8904500);
//     path_37.cubicTo(
...
//     Paint paint_37_fill = Paint()..style = PaintingStyle.fill;
//     paint_37_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_37, paint_37_fill);

//     Path path_38 = Path();
//     path_38.moveTo(size.width * 0.6519911, size.height * 0.5127000);
//     path_38.cubicTo(
...
//         size.width * 0.6519911,
//         size.height * 0.5127000);
//     path_38.moveTo(size.width * 0.6519911, size.height * 0.5531250);
//     path_38.cubicTo(
...
//     Paint paint_38_fill = Paint()..style = PaintingStyle.fill;
//     paint_38_fill.color = Color(0xffC69C6D).withOpacity(1.0);
//     canvas.drawPath(path_38, paint_38_fill);

//     Path path_39 = Path();
//     path_39.moveTo(size.width * 0.6519911, size.height * 0.5363500);
//     path_39.cubicTo(
...
//         size.width * 0.6519911,
//         size.height * 0.5363500);
//     path_39.moveTo(size.width * 0.6519911, size.height * 0.5531250);
//     path_39.cubicTo(
//         size.width * 0.6244978,
//         size.height * 0.5531250,
//         size.width * 0.6022133,
...
//     Path path_40 = Path();
//     path_40.moveTo(size.width * 0.6519911, size.height * 0.7236750);
//     path_40.cubicTo(
...
//     Path path_41 = Path();
//     path_41.moveTo(size.width * 0.8529867, size.height * 0.5127000);
//     path_41.cubicTo(
...
//         size.width * 0.8529867,
//         size.height * 0.5127000);
//     path_41.moveTo(size.width * 0.8529867, size.height * 0.5531250);
//     path_41.cubicTo(
...
//     Paint paint_41_fill = Paint()..style = PaintingStyle.fill;
//     paint_41_fill.color = Color(0xffC69C6D).withOpacity(1.0);
//     canvas.drawPath(path_41, paint_41_fill);

//     Path path_42 = Path();
//     path_42.moveTo(size.width * 0.8529867, size.height * 0.5363500);
//     path_42.cubicTo(
...
//         size.width * 0.8529867,
//         size.height * 0.5363500);
//     path_42.moveTo(size.width * 0.8529867, size.height * 0.5531250);
//     path_42.cubicTo(
//         size.width * 0.8254933,
//         size.height * 0.5531250,
//         size.width * 0.8032089,
...
//     Path path_43 = Path();
//     path_43.moveTo(size.width * 0.8529867, size.height * 0.7236750);
//     path_43.cubicTo(
...
//     Path path_44 = Path();
//     path_44.moveTo(size.width * 0.7088978, size.height * 0.5173000);
//     path_44.lineTo(size.width * 0.7033422, size.height * 0.4532000);
//     path_44.lineTo(size.width * 0.7120889, size.height * 0.4514750);
//     path_44.lineTo(size.width * 0.7132889, size.height * 0.4653500);
//     path_44.lineTo(size.width * 0.8115644, size.height * 0.4513250);
//     path_44.lineTo(size.width * 0.8052356, size.height * 0.4045750);
//     path_44.lineTo(size.width * 0.8148622, size.height * 0.3970000);
//     path_44.lineTo(size.width * 0.8223022, size.height * 0.4499500);
//     path_44.lineTo(size.width * 0.8254933, size.height * 0.4726250);
//     path_44.lineTo(size.width * 0.8564444, size.height * 0.6928500);
//     path_44.lineTo(size.width * 0.8513156, size.height * 0.7007000);
//     path_44.lineTo(size.width * 0.8178489, size.height * 0.4978000);
//     path_44.lineTo(size.width * 0.7526844, size.height * 0.7269250);
//     path_44.lineTo(size.width * 0.7430667, size.height * 0.7090000);
//     path_44.lineTo(size.width * 0.8081600, size.height * 0.4748250);
//     path_44.lineTo(size.width * 0.7152000, size.height * 0.4875000);
//     path_44.lineTo(size.width * 0.7342578, size.height * 0.7073000);
//     path_44.lineTo(size.width * 0.7426222, size.height * 0.7169000);
//     path_44.lineTo(size.width * 0.7426222, size.height * 0.7288000);
//     path_44.lineTo(size.width * 0.7426222, size.height * 0.7374750);
//     path_44.lineTo(size.width * 0.7426222, size.height * 0.7465500);
//     path_44.lineTo(size.width * 0.6493156, size.height * 0.7062500);
//     path_44.cubicTo(
...
//     path_44.lineTo(size.width * 0.7088978, size.height * 0.5173000);
//     path_44.close();
//     path_44.moveTo(size.width * 0.7253778, size.height * 0.7073500);
//     path_44.lineTo(size.width * 0.7111733, size.height * 0.5434750);
//     path_44.lineTo(size.width * 0.6593867, size.height * 0.6845750);
//     path_44.lineTo(size.width * 0.7253778, size.height * 0.7073500);
//     path_44.close();

//     Paint paint_44_fill = Paint()..style = PaintingStyle.fill;
//     paint_44_fill.color = Color(0xffFAFFFF).withOpacity(1.0);
//     canvas.drawPath(path_44, paint_44_fill);

//     Path path_45 = Path();
//     path_45.moveTo(size.width * 0.7282578, size.height * 0.7414000);
//     path_45.lineTo(size.width * 0.6493244, size.height * 0.7063000);
//     path_45.cubicTo(
...
//     path_45.lineTo(size.width * 0.7253422, size.height * 0.7285750);
//     path_45.lineTo(size.width * 0.7282578, size.height * 0.7414000);
//     path_45.close();

//     Paint paint_45_fill = Paint()..style = PaintingStyle.fill;
//     paint_45_fill.color = Color(0xffD8D8D8).withOpacity(1.0);
//     canvas.drawPath(path_45, paint_45_fill);

//     Path path_46 = Path();
//     path_46.moveTo(size.width * 0.8538844, size.height * 0.6968000);
//     path_46.lineTo(size.width * 0.8188533, size.height * 0.4822000);
//     path_46.lineTo(size.width * 0.7547022, size.height * 0.7029250);
//     path_46.lineTo(size.width * 0.7501511, size.height * 0.7222250);
//     path_46.lineTo(size.width * 0.7568533, size.height * 0.7122750);
//     path_46.lineTo(size.width * 0.8178489, size.height * 0.4978250);
//     path_46.lineTo(size.width * 0.8513156, size.height * 0.7007250);
//     path_46.close();

//     Paint paint_46_fill = Paint()..style = PaintingStyle.fill;
//     paint_46_fill.color = Color(0xffD8D8D8).withOpacity(1.0);
//     canvas.drawPath(path_46, paint_46_fill);

//     Path path_47 = Path();
//     path_47.moveTo(size.width * 0.7393244, size.height * 0.7929000);
//     path_47.cubicTo(
...
//     Path path_48 = Path();
//     path_48.moveTo(size.width * 0.7393333, size.height * 0.6809500);
//     path_48.cubicTo(
...
//     path_48.lineTo(size.width * 0.6556356, size.height * 0.6622250);
//     path_48.lineTo(size.width * 0.6548267, size.height * 0.6644250);
//     path_48.lineTo(size.width * 0.6536622, size.height * 0.6641500);
//     path_48.cubicTo(
...
//     path_48.lineTo(size.width * 0.6502844, size.height * 0.7221750);
//     path_48.lineTo(size.width * 0.6502844, size.height * 0.7222500);
//     path_48.cubicTo(
//         size.width * 0.6543733,
...
//         size.width * 0.7393156,
//         size.height * 0.6833750);
//     path_48.lineTo(size.width * 0.6658844, size.height * 0.6669000);
//     path_48.lineTo(size.width * 0.6666844, size.height * 0.6647000);
//     path_48.lineTo(size.width * 0.7393333, size.height * 0.6809500);
//     path_48.close();

//     Paint paint_48_fill = Paint()..style = PaintingStyle.fill;
//     paint_48_fill.color = Color(0xffFBB03B).withOpacity(1.0);
//     canvas.drawPath(path_48, paint_48_fill);

//     Path path_49 = Path();
//     path_49.moveTo(size.width * 0.7152178, size.height * 0.4875500);
//     path_49.lineTo(size.width * 0.8081778, size.height * 0.4748750);
//     path_49.lineTo(size.width * 0.8081778, size.height * 0.4676750);
//     path_49.lineTo(size.width * 0.7179111, size.height * 0.4803500);
//     path_49.close();

//     Paint paint_49_fill = Paint()..style = PaintingStyle.fill;
//     paint_49_fill.color = Color(0xffD8D8D8).withOpacity(1.0);
//     canvas.drawPath(path_49, paint_49_fill);

//     Path path_50 = Path();
//     path_50.moveTo(size.width * 0.8050311, size.height * 0.3998000);
//     path_50.lineTo(size.width * 0.7998844, size.height * 0.3617500);
//     path_50.cubicTo(
...
//         size.height * 0.3531500);
//     path_50.lineTo(size.width * 0.8292978, size.height * 0.3531500);
//     path_50.lineTo(size.width * 0.8326133, size.height * 0.3742250);
//     path_50.lineTo(size.width * 0.8105333, size.height * 0.3742250);
//     path_50.lineTo(size.width * 0.8144533, size.height * 0.4054500);
//     path_50.lineTo(size.width * 0.8050311, size.height * 0.3998000);
//     path_50.close();

//     Paint paint_50_fill = Paint()..style = PaintingStyle.fill;
//     paint_50_fill.color = Color(0xffFAFFFF).withOpacity(1.0);
//     canvas.drawPath(path_50, paint_50_fill);

//     Path path_51 = Path();
//     path_51.moveTo(size.width * 0.8050311, size.height * 0.3998000);
//     path_51.lineTo(size.width * 0.8147022, size.height * 0.3920500);
//     path_51.cubicTo(
...
//     path_51.lineTo(size.width * 0.8174044, size.height * 0.4013500);
//     path_51.cubicTo(
...
//     path_51.lineTo(size.width * 0.8065689, size.height * 0.4149750);
//     path_51.cubicTo(
...
//     path_51.lineTo(size.width * 0.8038667, size.height * 0.4056750);
//     path_51.cubicTo(
...
//     Path path_52 = Path();
//     path_52.moveTo(size.width * 0.8239200, size.height * 0.3566000);
//     path_52.cubicTo(
...
//     path_52.lineTo(size.width * 0.8430133, size.height * 0.3766750);
//     path_52.cubicTo(
...
//         size.height * 0.4642750);
//     path_52.lineTo(size.width * 0.8079289, size.height * 0.4642750);
//     path_52.cubicTo(
...
//         size.height * 0.4417750);
//     path_52.lineTo(size.width * 0.8330133, size.height * 0.4417750);
//     path_52.cubicTo(
...
//     path_52.lineTo(size.width * 0.8239200, size.height * 0.3566000);
//     path_52.close();
...
//     Path path_53 = Path();
//     path_53.moveTo(size.width * 0.7058667, size.height * 0.4527250);
//     path_53.lineTo(size.width * 0.7033156, size.height * 0.4477500);
//     path_53.lineTo(size.width * 0.7004711, size.height * 0.4118000);
//     path_53.lineTo(size.width * 0.7027822, size.height * 0.3991000);
//     path_53.lineTo(size.width * 0.7079644, size.height * 0.4120250);
//     path_53.lineTo(size.width * 0.7107022, size.height * 0.4466750);
//     path_53.close();

//     Paint paint_53_fill = Paint()..style = PaintingStyle.fill;
//     paint_53_fill.color = Color(0xffFAFFFF).withOpacity(1.0);
//     canvas.drawPath(path_53, paint_53_fill);

//     Path path_54 = Path();
//     path_54.moveTo(size.width * 0.7026044, size.height * 0.4479000);
//     path_54.lineTo(size.width * 0.7129067, size.height * 0.4464000);
//     path_54.cubicTo(
...
//     path_54.lineTo(size.width * 0.7148000, size.height * 0.4571750);
//     path_54.cubicTo(
...
//     path_54.lineTo(size.width * 0.7028978, size.height * 0.4636500);
//     path_54.cubicTo(
...
//     path_54.lineTo(size.width * 0.7010044, size.height * 0.4528750);
//     path_54.cubicTo(
...
//     Path path_55 = Path();
//     path_55.moveTo(size.width * 0.6776800, size.height * 0.3690500);
//     path_55.cubicTo(
...
//     Path path_56 = Path();
//     path_56.moveTo(size.width * 0.7393244, size.height * 0.7531250);
//     path_56.cubicTo(
...
//     Paint paint_56_fill = Paint()..style = PaintingStyle.fill;
//     paint_56_fill.color = Color(0xff2A2243).withOpacity(1.0);
//     canvas.drawPath(path_56, paint_56_fill);

//     Path path_57 = Path();
//     path_57.moveTo(size.width * 0.7365511, size.height * 0.7358250);
//     path_57.lineTo(size.width * 0.7365511, size.height * 0.7358250);
//     path_57.cubicTo(
...
//     path_57.lineTo(size.width * 0.7680800, size.height * 0.7477250);
//     path_57.lineTo(size.width * 0.7670311, size.height * 0.7614750);
//     path_57.lineTo(size.width * 0.7384711, size.height * 0.7441750);
//     path_57.cubicTo(
...
//     Paint paint_57_fill = Paint()..style = PaintingStyle.fill;
//     paint_57_fill.color = Color(0xffFAFFFF).withOpacity(1.0);
//     canvas.drawPath(path_57, paint_57_fill);

//     Path path_58 = Path();
//     path_58.moveTo(size.width * 0.7620178, size.height * 0.7516500);
//     path_58.lineTo(size.width * 0.7756356, size.height * 0.7446750);
//     path_58.cubicTo(
...
//         size.height * 0.7468750);
//     path_58.lineTo(size.width * 0.7773956, size.height * 0.7565250);
//     path_58.cubicTo(
...
//     path_58.lineTo(size.width * 0.7629956, size.height * 0.7666750);
//     path_58.cubicTo(
...
//     path_58.lineTo(size.width * 0.7612356, size.height * 0.7548250);
//     path_58.cubicTo(
...
//   void paint(Canvas canvas, Size size) {
//     Path path_0 = Path();
//     path_0.moveTo(size.width * 0.8187333, size.height * 0.5172500);
//     path_0.lineTo(size.width * 0.8187333, size.height * 0.3968000);
//     path_0.lineTo(size.width * 0.7647167, size.height * 0.3968000);
//     path_0.lineTo(size.width * 0.7647167, size.height * 0.2315500);
//     path_0.lineTo(size.width * 0.6882833, size.height * 0.2315500);
//     path_0.lineTo(size.width * 0.6882833, size.height * 0.3536250);
//     path_0.lineTo(size.width * 0.6648333, size.height * 0.3536250);
//     path_0.lineTo(size.width * 0.6648333, size.height * 0.1620500);
//     path_0.lineTo(size.width * 0.6016667, size.height * 0.1620500);
//     path_0.lineTo(size.width * 0.6016667, size.height * 0.3179000);
//     path_0.lineTo(size.width * 0.5812833, size.height * 0.3179000);
//     path_0.lineTo(size.width * 0.5812833, size.height * 0.2165000);
//     path_0.lineTo(size.width * 0.5300500, size.height * 0.2165000);
//     path_0.lineTo(size.width * 0.5300500, size.height * 0.4061750);
//     path_0.lineTo(size.width * 0.4987333, size.height * 0.4061750);
//     path_0.lineTo(size.width * 0.4987333, size.height * 0.3667500);
//     path_0.lineTo(size.width * 0.4600000, size.height * 0.3667500);
//     path_0.lineTo(size.width * 0.4600000, size.height * 0.3499750);
//     path_0.lineTo(size.width * 0.3835667, size.height * 0.3499750);
//     path_0.lineTo(size.width * 0.3835667, size.height * 0.4422000);
//     path_0.lineTo(size.width * 0.3601167, size.height * 0.4422000);
//     path_0.lineTo(size.width * 0.3601167, size.height * 0.2974750);
//     path_0.lineTo(size.width * 0.2969333, size.height * 0.2974750);
//     path_0.lineTo(size.width * 0.2969333, size.height * 0.4152500);
//     path_0.lineTo(size.width * 0.2765500, size.height * 0.4152500);
//     path_0.lineTo(size.width * 0.2765500, size.height * 0.3386250);
//     path_0.lineTo(size.width * 0.2253333, size.height * 0.3386250);
//     path_0.lineTo(size.width * 0.2253333, size.height * 0.4819250);
//     path_0.lineTo(size.width * 0.1940167, size.height * 0.4819250);
//     path_0.lineTo(size.width * 0.1940167, size.height * 0.4521250);
//     path_0.lineTo(size.width * 0.1379667, size.height * 0.4521250);
//     path_0.lineTo(size.width * 0.1379667, size.height * 0.5557000);
//     path_0.lineTo(size.width * 0.09821667, size.height * 0.5557000);
//     path_0.lineTo(size.width * 0.09821667, size.height * 0.5244750);
//     path_0.lineTo(size.width * 0.05955000, size.height * 0.5244750);
//     path_0.cubicTo(
...
//         size.height * 0.7086000);
//     path_0.lineTo(size.width * 0.8754833, size.height * 0.7086000);
//     path_0.cubicTo(
...
//     path_0.lineTo(size.width * 0.8919333, size.height * 0.5172500);
//     path_0.lineTo(size.width * 0.8187333, size.height * 0.5172500);
//     path_0.close();

//     Paint paint_0_fill = Paint()..style = PaintingStyle.fill;
//     paint_0_fill.color = Color(0xffE0E3E4).withOpacity(1.0);
//     canvas.drawPath(path_0, paint_0_fill);

//     Path path_1 = Path();
//     path_1.moveTo(size.width * 0.07405000, size.height * 0.7084750);
//     path_1.lineTo(size.width * 0.9313667, size.height * 0.7084750);
//     path_1.cubicTo(
...
//         size.height * 0.7160250);
//     path_1.lineTo(size.width * 0.07405000, size.height * 0.7160250);
//     path_1.cubicTo(
...
//     Paint paint_1_fill = Paint()..style = PaintingStyle.fill;
//     paint_1_fill.color = Color(0xffD2A866).withOpacity(1.0);
//     canvas.drawPath(path_1, paint_1_fill);

//     Paint paint_2_fill = Paint()..style = PaintingStyle.fill;
//     paint_2_fill.color = Color(0xffFAFFFF).withOpacity(1.0);
//     canvas.drawRect(
...
//     Paint paint_3_fill = Paint()..style = PaintingStyle.fill;
//     paint_3_fill.color = Color(0xff3A3C61).withOpacity(1.0);
//     canvas.drawRect(
...
//     Path path_4 = Path();
//     path_4.moveTo(size.width * 0.8203167, size.height * 0.1393500);
//     path_4.lineTo(size.width * 0.8400167, size.height * 0.1393500);
//     path_4.cubicTo(
...
//     path_4.lineTo(size.width * 0.8425000, size.height * 0.1468000);
//     path_4.lineTo(size.width * 0.8178333, size.height * 0.1468000);
//     path_4.lineTo(size.width * 0.8178333, size.height * 0.1430750);
//     path_4.cubicTo(
...
//     Paint paint_4_fill = Paint()..style = PaintingStyle.fill;
//     paint_4_fill.color = Color(0xff352A54).withOpacity(1.0);
//     canvas.drawPath(path_4, paint_4_fill);
...
//     Path path_8 = Path();
//     path_8.moveTo(size.width * 0.2675833, size.height * 0.7084750);
//     path_8.cubicTo(
...
//     path_8.lineTo(size.width * 0.1309833, size.height * 0.7084250);
//     path_8.lineTo(size.width * 0.2675833, size.height * 0.7084250);
//     path_8.close();

//     Paint paint_8_fill = Paint()..style = PaintingStyle.fill;
//     paint_8_fill.color = Color(0xffD2A866).withOpacity(1.0);
//     canvas.drawPath(path_8, paint_8_fill);

//     Path path_9 = Path();
//     path_9.moveTo(size.width * 0.7522167, size.height * 0.7084750);
//     path_9.cubicTo(
...
//     path_9.lineTo(size.width * 0.8752833, size.height * 0.7084500);
//     path_9.lineTo(size.width * 0.7522167, size.height * 0.7084500);
//     path_9.close();

//     Paint paint_9_fill = Paint()..style = PaintingStyle.fill;
//     paint_9_fill.color = Color(0xffD2A866).withOpacity(1.0);
//     canvas.drawPath(path_9, paint_9_fill);

//     Paint paint_10_fill = Paint()..style = PaintingStyle.fill;
//     paint_10_fill.color = Color(0xffFAFFFF).withOpacity(1.0);
//     canvas.drawRect(
...
//     Paint paint_11_fill = Paint()..style = PaintingStyle.fill;
//     paint_11_fill.color = Color(0xff3A3C61).withOpacity(1.0);
//     canvas.drawRect(
...
//     Path path_12 = Path();
//     path_12.moveTo(size.width * 0.1533833, size.height * 0.1393500);
//     path_12.lineTo(size.width * 0.1730833, size.height * 0.1393500);
//     path_12.cubicTo(
...
//         size.width * 0.1755667,
//         size.height * 0.1430750);
//     path_12.lineTo(size.width * 0.1755667, size.height * 0.1468000);
//     path_12.lineTo(size.width * 0.1509000, size.height * 0.1468000);
//     path_12.lineTo(size.width * 0.1509000, size.height * 0.1430750);
//     path_12.cubicTo(
...
//     Paint paint_12_fill = Paint()..style = PaintingStyle.fill;
//     paint_12_fill.color = Color(0xff352A54).withOpacity(1.0);
...
//     Path path_16 = Path();
//     path_16.moveTo(size.width * 0.2103167, size.height * 0.8646500);

//     Paint paint_16_fill = Paint()..style = PaintingStyle.fill;
//     paint_16_fill.color = Color(0xffD3BB8C).withOpacity(1.0);
//     canvas.drawPath(path_16, paint_16_fill);

//     Path path_17 = Path();
//     path_17.moveTo(size.width * 0.5613500, size.height * 0.8338500);
//     path_17.cubicTo(
...
//     Paint paint_17_fill = Paint()..style = PaintingStyle.fill;
//     paint_17_fill.color = Color(0xffB6DBF7).withOpacity(1.0);
//     canvas.drawPath(path_17, paint_17_fill);

//     Path path_18 = Path();
//     path_18.moveTo(size.width * 0.4981667, size.height * 0.8505500);
//     path_18.cubicTo(
...
//     Path path_19 = Path();
//     path_19.moveTo(size.width * 0.3142833, size.height * 0.4727750);
//     path_19.cubicTo(
...
//         size.width * 0.3142833,
//         size.height * 0.4727750);
//     path_19.moveTo(size.width * 0.3142833, size.height * 0.5132000);
//     path_19.cubicTo(
...
//     Path path_20 = Path();
//     path_20.moveTo(size.width * 0.3142833, size.height * 0.4964500);
//     path_20.cubicTo(
//         size.width * 0.3720000,
...
//         size.width * 0.3142833,
//         size.height * 0.4964500);
//     path_20.moveTo(size.width * 0.3142833, size.height * 0.5132000);
//     path_20.cubicTo(
//         size.width * 0.2627333,
//         size.height * 0.5132000,
//         size.width * 0.2209500,
...
//     Path path_21 = Path();
//     path_21.moveTo(size.width * 0.3142833, size.height * 0.6837750);
//     path_21.cubicTo(
...
//     Path path_22 = Path();
//     path_22.moveTo(size.width * 0.6911500, size.height * 0.4727750);
//     path_22.cubicTo(
...
//         size.width * 0.6911500,
//         size.height * 0.4727750);
//     path_22.moveTo(size.width * 0.6911500, size.height * 0.5132000);
//     path_22.cubicTo(
...
//     Path path_23 = Path();
//     path_23.moveTo(size.width * 0.6911500, size.height * 0.4964500);
//     path_23.cubicTo(
...
//         size.width * 0.6911500,
//         size.height * 0.4964500);
//     path_23.moveTo(size.width * 0.6911500, size.height * 0.5132000);
//     path_23.cubicTo(
//         size.width * 0.6396000,
//         size.height * 0.5132000,
//         size.width * 0.5978167,
...
//     Path path_24 = Path();
//     path_24.moveTo(size.width * 0.6911500, size.height * 0.6837750);
//     path_24.cubicTo(
...
//     Path path_25 = Path();
//     path_25.moveTo(size.width * 0.4209833, size.height * 0.4774000);
//     path_25.lineTo(size.width * 0.4105667, size.height * 0.4133000);
//     path_25.lineTo(size.width * 0.4269667, size.height * 0.4115750);
//     path_25.lineTo(size.width * 0.4292167, size.height * 0.4254500);
//     path_25.lineTo(size.width * 0.6134833, size.height * 0.4114250);
//     path_25.lineTo(size.width * 0.6016167, size.height * 0.3646750);
//     path_25.lineTo(size.width * 0.6196667, size.height * 0.3571000);
//     path_25.lineTo(size.width * 0.6336167, size.height * 0.4100500);
//     path_25.lineTo(size.width * 0.6396000, size.height * 0.4327250);
//     path_25.lineTo(size.width * 0.6976333, size.height * 0.6529500);
//     path_25.lineTo(size.width * 0.6880167, size.height * 0.6608000);
//     path_25.lineTo(size.width * 0.6252667, size.height * 0.4579000);
//     path_25.lineTo(size.width * 0.5030833, size.height * 0.6870250);
//     path_25.lineTo(size.width * 0.4850500, size.height * 0.6691000);
//     path_25.lineTo(size.width * 0.6071000, size.height * 0.4349250);
//     path_25.lineTo(size.width * 0.4328000, size.height * 0.4476000);
//     path_25.lineTo(size.width * 0.4685333, size.height * 0.6674000);
//     path_25.lineTo(size.width * 0.4842167, size.height * 0.6770000);
//     path_25.lineTo(size.width * 0.4842167, size.height * 0.6889000);
//     path_25.lineTo(size.width * 0.4842167, size.height * 0.6975750);
//     path_25.lineTo(size.width * 0.4842167, size.height * 0.7066500);
//     path_25.lineTo(size.width * 0.3092667, size.height * 0.6663500);
//     path_25.cubicTo(
...
//     path_25.lineTo(size.width * 0.4209833, size.height * 0.4774000);
//     path_25.close();
//     path_25.moveTo(size.width * 0.4518833, size.height * 0.6674250);
//     path_25.lineTo(size.width * 0.4252500, size.height * 0.5035500);
//     path_25.lineTo(size.width * 0.3281500, size.height * 0.6446500);
//     path_25.lineTo(size.width * 0.4518833, size.height * 0.6674250);
//     path_25.close();

//     Paint paint_25_fill = Paint()..style = PaintingStyle.fill;
//     paint_25_fill.color = Color(0xffFAFFFF).withOpacity(1.0);
//     canvas.drawPath(path_25, paint_25_fill);

//     Path path_26 = Path();
//     path_26.moveTo(size.width * 0.4572833, size.height * 0.7014750);
//     path_26.lineTo(size.width * 0.3092833, size.height * 0.6663750);
//     path_26.cubicTo(
//         size.width * 0.3030000,
...
//     path_26.lineTo(size.width * 0.4518167, size.height * 0.6886500);
//     path_26.lineTo(size.width * 0.4572833, size.height * 0.7014750);
//     path_26.close();

//     Paint paint_26_fill = Paint()..style = PaintingStyle.fill;
//     paint_26_fill.color = Color(0xffD8D8D8).withOpacity(1.0);
//     canvas.drawPath(path_26, paint_26_fill);

//     Path path_27 = Path();
//     path_27.moveTo(size.width * 0.6928333, size.height * 0.6568750);
//     path_27.lineTo(size.width * 0.6271500, size.height * 0.4423000);
//     path_27.lineTo(size.width * 0.5068667, size.height * 0.6630250);
//     path_27.lineTo(size.width * 0.4983333, size.height * 0.6823250);
//     path_27.lineTo(size.width * 0.5109000, size.height * 0.6723750);
//     path_27.lineTo(size.width * 0.6252667, size.height * 0.4579000);
//     path_27.lineTo(size.width * 0.6880167, size.height * 0.6608000);
//     path_27.close();

//     Paint paint_27_fill = Paint()..style = PaintingStyle.fill;
//     paint_27_fill.color = Color(0xffD8D8D8).withOpacity(1.0);
//     canvas.drawPath(path_27, paint_27_fill);

//     Path path_28 = Path();
//     path_28.moveTo(size.width * 0.4780333, size.height * 0.7529750);
//     path_28.cubicTo(
...
//     Path path_29 = Path();
//     path_29.moveTo(size.width * 0.4780500, size.height * 0.6410500);
//     path_29.cubicTo(
...
//     path_29.lineTo(size.width * 0.3211167, size.height * 0.6223250);
//     path_29.lineTo(size.width * 0.3196000, size.height * 0.6245250);
//     path_29.lineTo(size.width * 0.3174167, size.height * 0.6242500);
//     path_29.cubicTo(
...
//     path_29.lineTo(size.width * 0.3110833, size.height * 0.6822750);
//     path_29.lineTo(size.width * 0.3110833, size.height * 0.6823500);
//     path_29.cubicTo(
...
//         size.width * 0.4780167,
//         size.height * 0.6434750);
//     path_29.lineTo(size.width * 0.3403333, size.height * 0.6270000);
//     path_29.lineTo(size.width * 0.3418333, size.height * 0.6248000);
//     path_29.lineTo(size.width * 0.4780500, size.height * 0.6410500);
//     path_29.close();

//     Paint paint_29_fill = Paint()..style = PaintingStyle.fill;
//     paint_29_fill.color = Color(0xffFBB03B).withOpacity(1.0);
//     canvas.drawPath(path_29, paint_29_fill);

//     Path path_30 = Path();
//     path_30.moveTo(size.width * 0.4328333, size.height * 0.4476250);
//     path_30.lineTo(size.width * 0.6071333, size.height * 0.4349500);
//     path_30.lineTo(size.width * 0.6071333, size.height * 0.4277750);
//     path_30.lineTo(size.width * 0.4378833, size.height * 0.4404500);
//     path_30.close();

//     Paint paint_30_fill = Paint()..style = PaintingStyle.fill;
//     paint_30_fill.color = Color(0xffD8D8D8).withOpacity(1.0);
//     canvas.drawPath(path_30, paint_30_fill);

//     Path path_31 = Path();
//     path_31.moveTo(size.width * 0.6012333, size.height * 0.3598750);
//     path_31.lineTo(size.width * 0.5915833, size.height * 0.3218250);
//     path_31.cubicTo(
...
//         size.width * 0.5955833,
//         size.height * 0.3132250);
//     path_31.lineTo(size.width * 0.6467333, size.height * 0.3132250);
//     path_31.lineTo(size.width * 0.6529500, size.height * 0.3343000);
//     path_31.lineTo(size.width * 0.6115500, size.height * 0.3343000);
//     path_31.lineTo(size.width * 0.6189000, size.height * 0.3655250);
//     path_31.lineTo(size.width * 0.6012333, size.height * 0.3598750);
//     path_31.close();

//     Paint paint_31_fill = Paint()..style = PaintingStyle.fill;
//     paint_31_fill.color = Color(0xffFAFFFF).withOpacity(1.0);
//     canvas.drawPath(path_31, paint_31_fill);

//     Path path_32 = Path();
//     path_32.moveTo(size.width * 0.6012333, size.height * 0.3598750);
//     path_32.lineTo(size.width * 0.6193667, size.height * 0.3521250);
//     path_32.cubicTo(
...
//     path_32.lineTo(size.width * 0.6244333, size.height * 0.3614250);
//     path_32.cubicTo(
...
//     path_32.lineTo(size.width * 0.6041167, size.height * 0.3750500);
//     path_32.cubicTo(
...
//     path_32.lineTo(size.width * 0.5990500, size.height * 0.3657500);
//     path_32.cubicTo(
...
//     Path path_33 = Path();
//     path_33.moveTo(size.width * 0.6366500, size.height * 0.3167000);
//     path_33.cubicTo(
...
//     path_33.lineTo(size.width * 0.6724500, size.height * 0.3367750);
//     path_33.cubicTo(
...
//         size.height * 0.4243750);
//     path_33.lineTo(size.width * 0.6066667, size.height * 0.4243750);
//     path_33.cubicTo(
...
//         size.height * 0.4018750);
//     path_33.lineTo(size.width * 0.6537000, size.height * 0.4018750);
//     path_33.cubicTo(
...
//     path_33.lineTo(size.width * 0.6366500, size.height * 0.3167000);
//     path_33.close();
...
//     Path path_34 = Path();
//     path_34.moveTo(size.width * 0.4153000, size.height * 0.4128000);
//     path_34.lineTo(size.width * 0.4105167, size.height * 0.4078500);
//     path_34.lineTo(size.width * 0.4051833, size.height * 0.3719000);
//     path_34.lineTo(size.width * 0.4095167, size.height * 0.3592000);
//     path_34.lineTo(size.width * 0.4192333, size.height * 0.3721250);
//     path_34.lineTo(size.width * 0.4243667, size.height * 0.4067750);
//     path_34.close();

//     Paint paint_34_fill = Paint()..style = PaintingStyle.fill;
//     paint_34_fill.color = Color(0xffFAFFFF).withOpacity(1.0);
//     canvas.drawPath(path_34, paint_34_fill);

//     Path path_35 = Path();
//     path_35.moveTo(size.width * 0.4091833, size.height * 0.4079750);
//     path_35.lineTo(size.width * 0.4285000, size.height * 0.4064750);
//     path_35.cubicTo(
...
//     path_35.lineTo(size.width * 0.4320500, size.height * 0.4172500);
//     path_35.cubicTo(
...
//         size.height * 0.4222500);
//     path_35.lineTo(size.width * 0.4097333, size.height * 0.4237250);
//     path_35.cubicTo(
...
//     path_35.lineTo(size.width * 0.4061833, size.height * 0.4129500);
//     path_35.cubicTo(
...
//     Path path_36 = Path();
//     path_36.moveTo(size.width * 0.3624500, size.height * 0.3291500);
//     path_36.cubicTo(
...
//     Path path_37 = Path();
//     path_37.moveTo(size.width * 0.4780333, size.height * 0.7132000);
//     path_37.cubicTo(
...
//     Paint paint_37_fill = Paint()..style = PaintingStyle.fill;
//     paint_37_fill.color = Color(0xff2A2243).withOpacity(1.0);
//     canvas.drawPath(path_37, paint_37_fill);

//     Path path_38 = Path();
//     path_38.moveTo(size.width * 0.4728333, size.height * 0.6959250);
//     path_38.lineTo(size.width * 0.4728333, size.height * 0.6959250);
//     path_38.cubicTo(
...
//     path_38.lineTo(size.width * 0.5319500, size.height * 0.7078250);
//     path_38.lineTo(size.width * 0.5299833, size.height * 0.7215750);
//     path_38.lineTo(size.width * 0.4764333, size.height * 0.7042750);
//     path_38.cubicTo(
...
//     Paint paint_38_fill = Paint()..style = PaintingStyle.fill;
//     paint_38_fill.color = Color(0xffFAFFFF).withOpacity(1.0);
//     canvas.drawPath(path_38, paint_38_fill);

//     Path path_39 = Path();
//     path_39.moveTo(size.width * 0.5205833, size.height * 0.7117500);
//     path_39.lineTo(size.width * 0.5461167, size.height * 0.7047750);
//     path_39.cubicTo(
...
//         size.height * 0.7069750);
//     path_39.lineTo(size.width * 0.5494167, size.height * 0.7166250);
//     path_39.cubicTo(
//         size.width * 0.5496000,
...
//     path_39.lineTo(size.width * 0.5224167, size.height * 0.7267750);
//     path_39.cubicTo(
...
//     path_39.lineTo(size.width * 0.5191167, size.height * 0.7149250);
//     path_39.cubicTo(
